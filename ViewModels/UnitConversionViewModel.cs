namespace ViewModels
{
    ...
    {
        //Tension Conversion
        public float ConvertTension(float tension, string unit)
        {
            float converted;
            switch (unit)
            {
                case "lbf":
                    converted = ConvertFromPound(tension, unit);
                    break;

                case "kg":
                    converted = ConvertFromKg(tension, unit);
                    break;

                case "kip":
                    converted = ConvertFromKip(tension, unit);
                    break;

                case "N":
                    converted = ConvertFromNewton(tension, unit);
                    break;

                case "Short Ton":
                    converted = ConvertFromShortTon(tension, unit);
                    break;

                case "Long Ton":
                    converted = ConvertFromLongTon(tension, unit);
                    break;

                case "Tonne":
                    converted = ConvertFromTonne(tension, unit);
                    break;
        ...
        //Payout Conversion
        public float ConvertPayout(float payout, string unit)
        {
            float converted;
            switch (unit)
            {
                case "m":
                    converted = ConvertFromKMeters(payout, unit);
                    break;

                case "ft":
                    converted = ConvertFromFeet(payout, unit);
                    break;
        ...
        //Speed Conversion
        public float ConvertSpeed(float speed, string unit)
        {
            float converted;
            switch (unit)
            {   
                case "m/min":
                    converted = ConvertFromMeterperMin(speed, unit);
                    break;

                case "ft/min":
                    converted = ConvertFromFeetperMin(speed, unit);
                    break;

                case "kph":
                    converted = ConvertFromKPH(speed, unit);
                    break;

                case "mph":
                    converted = ConvertFromMPH(speed, unit);
                    break;
                case "m/sec":
                    converted = ConvertFromMPS(speed, unit);
                    break;
